...
labelconv1 = Label(frameconv1,text="Input File(with extention)",font=("gothic",10),bg="#696969",fg="#000000")
labelconv1.pack(side="right")
entryconv1 = Entry(frameconv1,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entryconv1.pack(side="left")
labelconv2 = Label(frameconv2,text="Output File(with extention)",font=("gothic",10),bg="#696969",fg="#000000")
labelconv2.pack(side="right")
entryconv2 = Entry(frameconv2,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entryconv2.pack(side="left")

labelcut1 = Label(framecut1,text="Input File(with extention)",font=("gothic",10),bg="#696969",fg="#000000")
labelcut1.pack(side="right")
entrycut1 = Entry(framecut1,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entrycut1.pack(side="left")
labelcut2 = Label(framecut2,text="Start Time(in format hh:mm:ss, or hh:mm:ss:ms)",font=("gothic",10),bg="#696969",fg="#000000")
labelcut2.pack(side="right")
entrycut2 = Entry(framecut2,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entrycut2.pack(side="left")
labelcut3 = Label(framecut3,text="End Time(in format hh:mm:ss, or hh:mm:ss:ms)",font=("gothic",10),bg="#696969",fg="#000000")
labelcut3.pack(side="right")
entrycut3 = Entry(framecut3,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entrycut3.pack(side="left")
labelcut4 = Label(framecut4,text="Output File(with extention)",font=("gothic",10),bg="#696969",fg="#000000")
...
labelcookies = Label(frameytdlp4, text="Input File(cookies copied to a .txt file)", font=("gothic", 10),bg="#696969",fg="#000000")
labelcookies.pack(side="right")
entrycookies = Entry(frameytdlp4, width=20, font=("gothic", 9),bg="#696969",fg="#000000")
entrycookies.pack(side="left")

labeltwtcst1 = Label(frametwtcst1,text="User_Agent",font=("gothic",10),bg="#696969",fg="#000000")
labeltwtcst1.pack(side="right")
entrytwtcst1 = Entry(frametwtcst1,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entrytwtcst1.pack(side="left")
labeltwtcst2 = Label(frametwtcst2,text="Link",font=("gothic",10),bg="#696969",fg="#000000")
labeltwtcst2.pack(side="right")
entrytwtcst2 = Entry(frametwtcst2,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entrytwtcst2.pack(side="left")
labeltwtcst3 = Label(frametwtcst3,text="Output file name",font=("gothic",10),bg="#696969",fg="#000000")
...
labelstrlnk3 = Label(framestrlnk8,text="Download file name(with extention)",font=("gothic",10),bg="#696969",fg="#000000")
labelstrlnk3.pack(side="right")
entrystrlnk3 = Entry(framestrlnk8,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entrystrlnk3.pack(side="left")

labelfanbox1 = Label(framefanbox1,text="Session ID",font=("gothic",10),bg="#696969",fg="#000000")
labelfanbox1.pack(side="right")
entryfanbox1 = Entry(framefanbox1,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entryfanbox1.pack(side="left")
labelfanbox2 = Label(framefanbox2,text="Creator ID",font=("gothic",10),bg="#696969",fg="#000000")
labelfanbox2.pack(side="right")
entryfanbox2 = Entry(framefanbox2,width=20,font=("gothic",9),bg="#696969",fg="#000000")
entryfanbox2.pack(side="left")

labelconv3 = Label(frameconv3,text="Video to Video",font=("gothic",10),bg="#696969",fg="#000000")
labelconv3.pack(side="right")
buttonconv1 = Button(frameconv3,text="Convert",command=buttonconv1_press,font=("gothic",9),width=19,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonconv1.pack(side="left")
labelconv4 = Label(frameconv4,text="Video to mp3(extension not required)",font=("gothic",10),bg="#696969",fg="#000000")
labelconv4.pack(side="right")
buttonconv2 = Button (frameconv4,text="Convert",command=buttonconv2_press,font=("gothic",9),width=19,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
...
buttonytdlp1 = Button(frameytdlp2,text="Download",font=("gothic",9),command=buttonytdlp1_press,width=19,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonytdlp1.pack(side="left")
labelytdlp2 = Label(frameytdlp2sub,text="w/o Cookies(w/ subtitles)",font=("gothic",10),bg="#696969",fg="#000000")
labelytdlp2.pack(side="right")
buttonytdlp1 = Button(frameytdlp2sub,text="Download",font=("gothic",9),command=buttonytdlp1sub_press,width=19,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonytdlp1.pack(side="left")
labelytdlp3 = Label(frameytdlp3,text="w/ Cookies",font=("gothic",10),bg="#696969",fg="#000000")
labelytdlp3.pack(side="right")
buttonytdlp2 = Button(frameytdlp3,text="Download",font=("gothic",9),command=buttonytdlp2_press,width=19,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonytdlp2.pack(side="left")
labelytdlp3 = Label(frameytdlp3sub,text="w/ Cookies(w/ subtitles)",font=("gothic",10),bg="#696969",fg="#000000")
labelytdlp3.pack(side="right")
buttonytdlp2 = Button(frameytdlp3sub,text="Download",font=("gothic",9),command=buttonytdlp2sub_press,width=19,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonytdlp2.pack(side="left")
labelcookies = Label(frameytdlp5,text="Convert Cookies(convert-cookies.js required)",font=("gothic",10),bg="#696969",fg="#000000")
labelcookies.pack(side="right")
...
labelstrlnk3 = Label(framestrlnk3,text="VLC",font=("gothic",10),bg="#696969",fg="#000000")
labelstrlnk3.pack(side="right")
buttonstrlnk1 = Button(framestrlnk3,text="Play",font=("gothic",9),width=19,command=buttonstrlnk1_press,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonstrlnk1.pack(side="left")
labelstrlnk4 = Label(framestrlnk4,text="MPC-64bit",font=("gothic",10),bg="#696969",fg="#000000")
labelstrlnk4.pack(side="right")
buttonstrlnk2 = Button(framestrlnk4,text="Play",font=("gothic",9),width=19,command=buttonstrlnk2_press,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonstrlnk2.pack(side="left")
labelstrlnk5 = Label(framestrlnk5,text="MPC-32bit",font=("gothic",10),bg="#696969",fg="#000000")
labelstrlnk5.pack(side="right")
buttonstrlnk3 = Button(framestrlnk5,text="Play",font=("gothic",9),width=19,command=buttonstrlnk3_press,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonstrlnk3.pack(side="left")
labelstrlnk6 = Label(framestrlnk6,text="Different Player",font=("gothic",10),bg="#696969",fg="#000000")
labelstrlnk6.pack(side="right")
buttonstrlnk4 = Button(framestrlnk6,text="Play",font=("gothic",9),width=19,command=buttonstrlnk4_press,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonstrlnk4.pack(side="left")
labelstrlnk7 = Label(framestrlnk7,text="Download Video/Stream while it's live",font=("gothic",10),bg="#696969",fg="#000000")
labelstrlnk7.pack(side="right")
buttonstrlnk5 = Button(framestrlnk7,text="Download",font=("gothic",9),width=19,command=buttonstrlnk5_press,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonstrlnk5.pack(side="left")

labelfanbox3 = Label(framefanbox3,text="All works of mentioned creator",font=("gothic",10),bg="#696969",fg="#000000")
labelfanbox3.pack(side="right")
buttonfanbox1 = Button(framefanbox3,text="Download",command=buttonfanbox1_press,font=("gothic",9),width=19,bg="#696969",fg="#000000",activebackground="#696969",activeforeground="#000000")
buttonfanbox1.pack(side="left")

textinfo = Text(info,font=("gothic",9),bg="#696969",fg="#000000")
